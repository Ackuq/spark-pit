...
/** Base SQL parsing infrastructure.
  */
abstract class CustomAbstractSqlParser
  ...
  override def parseFunctionIdentifier(sqlText: String): FunctionIdentifier = {
    parse(sqlText) { parser =>
      astBuilder.visitSingleFunctionIdentifier(
        parser.singleFunctionIdentifier()
      )
    }
  }
  ...
  override def parseMultipartIdentifier(sqlText: String): Seq[String] = {
    parse(sqlText) { parser =>
      astBuilder.visitSingleMultipartIdentifier(
        parser.singleMultipartIdentifier()
      )
    }
  }
  ...
  /** Creates StructType for a given SQL string, which is a comma separated list of field
    ...
    */
  override def parseTableSchema(sqlText: String): StructType = parse(sqlText) {
    parser =>
    ...
    parser =>
      astBuilder.visitSingleStatement(parser.singleStatement()) match {
        ...
        case _ =>
          ...
          throw QueryParsingErrors.sqlStatementUnsupportedError(
            sqlText,
            position
          )
      }
  ...
  protected def astBuilder: CustomAstBuilder
...
/** Concrete SQL parser for Catalyst-only SQL statements.
  */
class CustomCatalystSqlParser extends CustomAbstractSqlParser {
  val astBuilder = new CustomAstBuilder
  logInfo("Hello from custom SQL parser")
}

/** For test-only. */
object CustomCatalystSqlParser extends CustomCatalystSqlParser
...
case object PostProcessor extends SqlBaseBaseListener {
  ...
  override def exitQuotedIdentifier(
      ctx: SqlBaseParser.QuotedIdentifierContext
  ): Unit = {
...
case class UnclosedCommentProcessor(
  ...
  override def exitSingleDataType(
      ctx: SqlBaseParser.SingleDataTypeContext
  ): Unit = {
    checkUnclosedComment(tokenStream, command)
  }

  override def exitSingleExpression(
      ctx: SqlBaseParser.SingleExpressionContext
  ): Unit = {
    checkUnclosedComment(tokenStream, command)
  }

  override def exitSingleTableIdentifier(
      ctx: SqlBaseParser.SingleTableIdentifierContext
  ): Unit = {
    checkUnclosedComment(tokenStream, command)
  }

  override def exitSingleFunctionIdentifier(
      ctx: SqlBaseParser.SingleFunctionIdentifierContext
  ): Unit = {
    checkUnclosedComment(tokenStream, command)
  }
  ...
  override def exitSingleTableSchema(
      ctx: SqlBaseParser.SingleTableSchemaContext
  ): Unit = {
    checkUnclosedComment(tokenStream, command)
  }
  ...
  override def exitSingleStatement(
      ctx: SqlBaseParser.SingleStatementContext
  ): Unit = {
  ...
  private def checkUnclosedComment(
      tokenStream: CommonTokenStream,
      command: String
  ) = {
